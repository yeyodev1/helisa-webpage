...
const catalogSections: TechnologySection[] = [
  {
    ...
    summary: 'Soluciones compactas e industriales para agua de alta pureza con control de sales disueltas, metales y contaminantes críticos.',
    intro: 'Diseñamos e instalamos sistemas de ósmosis inversa para hogares, industrias, laboratorios y plantas de agua. El catálogo incluye pretratamiento, bombas de alta presión, membranas TFC y skids listos para operación continua.',
    image: '/images/curso-carbon.jpg',
    equipment: ['Equipos domésticos de 1 a 5 etapas', 'Sistemas compactos para oficina y comercio', 'Skids industriales con control de presión y flujo', 'Bombas presurizadoras y multietapa'],
    spareParts: ['Membranas RO TFC', 'Cartuchos sedimentadores y carbón', 'Carcasas porta membrana', 'Manómetros, válvulas check y caudalímetros'],
    subproducts: ['Bebederos', 'Tanques presurizados', 'Grifos para agua purificada', 'Kits de conexión, sanitización y arranque'],
  },
  {
    slug: 'ozono',
    eyebrow: 'Oxidación avanzada',
    title: 'Ozono',
    summary: 'Desinfección sin químicos para agua y aire con alto poder oxidante, bajo mantenimiento y respuesta inmediata.',
    intro: 'El ozono es ideal para eliminar bacterias, virus, hongos, olores y compuestos orgánicos. Lo aplicamos en agua, ambientes y procesos industriales donde se requiere sanidad, control microbiológico y reducción de carga orgánica.',
    image: '/images/patio-naves.webp',
    equipment: ['Generadores de ozono por descarga corona', 'Inyectores Venturi y mezcladores estáticos', 'Contactores y tanques de reacción', 'Destructores de ozono y sensores de seguridad'],
    spareParts: ['Piedras difusoras', 'Mangueras y conectores resistentes a oxidación', 'Válvulas check', 'Placas dieléctricas y celdas de reemplazo'],
    subproducts: ['Difusores para tanques', 'Paneles de control y ORP', 'Filtros de pretratamiento', 'Kits de ozonización para agua, aire y superficies'],
  },
  {
    slug: 'esterilizacion-uv',
    eyebrow: 'Desinfección final',
    title: 'Esterilización UV',
    summary: 'Tecnología segura y ecológica para desactivar microorganismos sin alterar sabor, olor ni composición del agua.',
    intro: 'La esterilización UV es el complemento ideal para plantas de agua, laboratorios, clínicas y sistemas industriales que necesitan una barrera sanitaria confiable, continua y de baja huella operativa.',
    image: '/images/nave-supersacos.jpg',
    equipment: ['Reactores UV de baja y alta presión', 'Lámparas UV-C de 254 nm', 'Balastros electrónicos', 'Sensores de intensidad y cámaras sanitarias'],
    spareParts: ['Camisas de cuarzo', 'Lámparas de reemplazo', 'O-rings y sellos', 'Controladores de intensidad y horas de uso'],
    subproducts: ['Prefiltros para UV', 'Monitores de dosis', 'Cámaras de paso en acero inoxidable', 'Sistemas para agua potable y procesos'],
  },
]

const whyUs = [
  { icon: 'fa-circle-check', title: 'Catálogo técnico', desc: 'Desglose claro de tecnologías, equipos, repuestos y subproductos.' },
  { icon: 'fa-chart-line', title: 'Más de 50,000 productos vendidos', desc: 'Respaldo comercial sólido que acompaña nuestra trayectoria en todo el país.' },
