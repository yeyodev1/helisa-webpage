...
// Contenido por defecto: es el mismo texto que ya está publicado en /nosotros.
// Se usa como valor inicial para que, si la API aún no responde, el formulario
// muestre el contenido real (editable) en vez de aparecer vacío.
